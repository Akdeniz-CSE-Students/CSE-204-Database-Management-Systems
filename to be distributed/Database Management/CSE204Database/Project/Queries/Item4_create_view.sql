...
c.ComplaintId, 
c.ComplaintHousingEstateId, 
c.ComplaintResidentId, 
c.ComplaintComplaint, 
c.ComplaintDate,
c.ComplaintIsSolved,
f.FlatId,
...
INNER JOIN Complaints c ON h.HousingEstateId = c.ComplaintHousingEstateId
INNER JOIN Flat f ON f.ApartmentId = a.ApartmentId
INNER JOIN Resident r ON r.flatId = f.flatId
INNER JOIN Elevator el ON el.ElevatorId = a.ElevatorId
